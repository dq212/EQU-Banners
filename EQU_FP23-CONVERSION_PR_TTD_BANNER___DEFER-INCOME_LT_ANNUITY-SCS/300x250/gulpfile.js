...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("EQU_FP23-CONSIDERATION_PR_TTD_BANNER___DEFY-STRESS_LM_300X250__STATIC.gif"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("EQU_FP23-CONSIDERATION_PR_TTD_BANNER___DEFY-STRESS_LM_300X250_.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);