...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("EQU_FP23-CONVERSION_PR_TTD_BANNER___DEFER-INCOME_LT_HTML5__6043_300X250_ANNUITY-SCS_STATIC.jpg"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("EQU_FP23-CONVERSION_PR_TTD_BANNER___DEFER-INCOME_LT_HTML5__6043_300X250_ANNUITY-SCS.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);