...
<
div id = "athena" > < img src = "../img/athena@2x.png"
alt = "" / > < /div>

<
div id = "blue-2" > < img src = "../img/blue-2@2x.png"
alt = "" / > < /div> <
    div id = "blue-3" > < img src = "../img/blue-3@2x.png"
alt = "" / > < /div> <
    div id = "blue-1" > < img src = "../img/blue-1@2x.png"
alt = "" / > < /div>

<
div id = "copy-1" > < img src = "../img/copy-1@2x.png"
alt = "" / > < /div> <
    div id = "copy-2" > < img src = "../img/copy-2@2x.png"
alt = "" / > < /div> <
    div id = "copy-3" > < img src = "../img/copy-3@2x.png"
alt = "" / > < /div> <
    div id = "copy-4" > < img src = "../img/copy-4@2x.png"
alt = "" / > < /div>



<
div id = "logo" > < img src = "../img/logo@2x.png"
alt = "" / > < /div> <
    div id = "logo-blue" > < img src = "../img/logo_blue@2x.png"
alt = "" / > < /div> <
    div id = "cta" >
    <
...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("EQU_FP23-CONSIDERATION_PR_TTD_BANNER___DEFY-STRESS_LM_300X50__STATIC.gif"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("EQU_FP23-CONSIDERATION_PR_TTD_BANNER___DEFY-STRESS_LM_300X50_.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);