...
gulp.task("copyStatic", function() {
    gulp
        ...
        .pipe(rename("EQU_FP23-CONVERSION_PR_TTD_BANNER___TACKLE-INFLATION_LT_HTML5__6043_300X50_ANNUITY-IE_STATIC.gif"))
...
gulp.task(
    ...
    function() {
        return gulp
            .src(dist + "/*")
            .pipe(zip("EQU_FP23-CONVERSION_PR_TTD_BANNER___TACKLE-INFLATION_LT_HTML5__6043_300X50_ANNUITY-IE.zip"))
            .pipe(gulp.dest("../HTML/"));
    }
);