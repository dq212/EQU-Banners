...
(function() {
    ...
    var timeline;
    var tl;
    var wrapper, clickThrough, disc_open, disc_close, logo, copy, cta, width, height, ids;
    ...
    nameSpace.init = function() {
        ...
        disc_close = document.getElementById("disclosure");
        cta = nameSpace.$("#cta");
        /* end added by me */
    ...
    nameSpace.initClickTag = function() {
        ...
        disc_open.onclick = function() {
            TweenMax.killTweensOf("#cta");TweenMax.set("#disclosure", {autoAlpha:1});
